...
ALTER TABLE IF EXISTS ONLY public.quotes DROP CONSTRAINT IF EXISTS fk_rails_21b39ace6d;
...
DROP INDEX IF EXISTS public.index_quotes_on_current_version_id;
...
CREATE TABLE public.quote_versions (
    ...
    organization_id uuid NOT NULL,
    quote_id uuid NOT NULL,
    sequential_id integer DEFAULT 1 NOT NULL,
...
--
-- Name: index_quotes_on_current_version_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_quotes_on_current_version_id ON public.quotes USING btree (current_version_id);
...
--
-- Name: quotes fk_rails_21b39ace6d; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.quotes
    ADD CONSTRAINT fk_rails_21b39ace6d FOREIGN KEY (current_version_id) REFERENCES public.quote_versions(id);
