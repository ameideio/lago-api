...
class Quote < ApplicationRecord
  ...
  has_one :order_form, inverse_of: :quote
  ...
  has_many :versions, class_name: "QuoteVersion", inverse_of: :quote
  belongs_to :current_version, class_name: "QuoteVersion", optional: true
...
# Indexes
#
#  index_quotes_on_current_version_id                 (current_version_id)
...
# Foreign Keys
#
#  fk_rails_...  (current_version_id => quote_versions.id)
